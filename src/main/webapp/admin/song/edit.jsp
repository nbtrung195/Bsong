...
<div id="page-wrapper">
    <div id="page-inner">
        ...
        if(Song != null){
        	name = Song.getName();
        	catId = String.valueOf(Song.getCategory().getIdCat());
        	preview = Song.getPreviewText();
        	detail = Song.getDetailText();
        	picture = Song.getPicture();
        	youtube = Song.getYoutube();
        }
        if("1".equals(err)){
        	out.print("<p style = \"color:red\">Có lỗi khi sửa</P>");
        }
        %>
        <hr />
        <div class="row">
                            ...
                            <div class="col-md-12">
                                <form action="" role="form" method="post" enctype="multipart/form-data" id="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <%if(!picture.isEmpty()){%>
                                        <img width="200px" height="200px" alt="" src="<%=request.getContextPath()%>/files/<%=picture%>">
                                        <%}%>
                                    </div>
                                    <div class="form-group">
