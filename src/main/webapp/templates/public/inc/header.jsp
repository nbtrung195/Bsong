...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li  id="home_action" ><a href="<%=request.getContextPath()%>/index"><span>Trang chủ</span></a>
          <li id="contact_action"><a href="<%=request.getContextPath()%>/lien-he"><span>Liên hệ</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
